...
function createEmptyCharityRedFlowerState(activityId) {
    return {
...
function normalizeCharityRedFlowerState(value, activityId) {
...
function mergeCharityRedFlowerStates(activityId, ...states) {
    const expectedActivityId = normalizeId(activityId);
...
function loadCharityRedFlowerState(activityId, accountId, options = {}) {
...
function persistCharityRedFlowerState(stateValue, activityId, accountId, options = {}) {
    const normalizedActivityId = normalizeId(activityId);
    const filePath = getActivityCenterStateFile(accountId, options);
    const file = normalizeStateFile(readJsonFile(filePath, emptyStateFile));
    const merged = mergeCharityRedFlowerStates(normalizedActivityId, file.charityRecords[normalizedActivityId], stateValue);
