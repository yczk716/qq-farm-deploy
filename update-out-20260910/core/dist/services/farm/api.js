 ...
 */
async function fertilize(landIds, fertilizerId = NORMAL_FERTILIZER_ID, propagateErrors = false) {
    let successCount = 0;
 ...
 */
async function fertilizeOrganicLoop(landIds, propagateErrors = false) {
