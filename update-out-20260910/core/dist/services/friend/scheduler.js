...
function startFriendCheckLoop(options = {}) {
    ...
    // 启动时检查一次待处理的好友申请
    friendScheduler.setTimeoutTask('friend_check_bootstrap_applications', 3000, () => (runExclusiveAutomationTask('friend_applications_bootstrap', checkAndAcceptApplications).catch(() => null)));
